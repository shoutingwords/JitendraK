          ...
          <div class="content row">
              <section class="main col col-lg-8">
                      ...
                      <ul class="media-list featured-post-list">
                        <li class="media">
                            <a class="pull-left" href="#">
                                <img class="media-object" src="images/tn_01.jpg" alt="...">
                            </a>
                        ...
                        <li class="media">
                          <a class="pull-left" href="#">
                              <img class="media-object" src="images/tn_02.jpg" alt="...">
                          </a>
                          <div class="media-body">
                        ...
                        <li class="media">
                          <a class="pull-left" href="#">
                              <img class="media-object" src="images/tn_03.jpg" alt="...">
                          </a>
                          <div class="media-body">
                        ...
                        <li class="media">
                          <a class="pull-left" href="#">
                              <img class="media-object" src="images/tn_04.jpg" alt="...">
                          </a>
                          <div class="media-body">
                        ...
                        <li class="media">
                          ...
                          <div class="media-body">
                              <h4 class="media-heading">3 Apps Any Whiskey Fan Would Love</h4>
                          </div>
                        </li>
                        <li class="media">
                          <a class="pull-left" href="#">
                ...
                <div class="popular-posts row">
                  ...
                  <h3 class="popular-post-label">Popular Content</h3>

                  <div class="col col-lg-4">
                      <div class="thumbnail">
                          <img data-src="holder.js/296x167" alt="...">
                          <div class="caption">
