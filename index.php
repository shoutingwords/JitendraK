      <?php get_header(); ?>
        	...
        	<div class="content row">
                ...
                <div class="featured-posts row visible-lg">

                  <section class="col col-lg-7 featured-post-big">
                        <article class="thumbnail post-thumbnail">
                          <img src="<?php echo get_template_directory_uri() . "/images/featured-image.jpg"; ?>" alt="..." class="img-responsive">
                ...
                <section class="col col-lg-5 featured-post-box">
                  <div id="feature-post-carousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="item active feature-post-item">
                            <ul class="media-list featured-post-list">
                              <li class="media">
                                  <a class="pull-left" href="#">
                                      <img class="media-object img-responsive" src="<?php echo get_template_directory_uri() . "/images/tn_01.jpg"; ?>" alt="...">
                                  </a>
                              ...
                              <li class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object img-responsive" src="<?php echo get_template_directory_uri() . "/images/tn_02.jpg"; ?>" alt="...">
                                </a>
                                <div class="media-body">
                              ...
                              <li class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object img-responsive" src="<?php echo get_template_directory_uri() . "/images/tn_03.jpg"; ?>" alt="...">
                                </a>
                                <div class="media-body">
                              ...
                              <li class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object img-responsive" src="<?php echo get_template_directory_uri() . "/images/tn_04.jpg"; ?>" alt="...">
                                </a>
                                <div class="media-body">
                        ...
                        <div class="item feature-post-item">
                            <ul class="media-list featured-post-list">
                              <li class="media">
                                  <a class="pull-left" href="#">
